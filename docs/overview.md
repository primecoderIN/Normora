...
- **White-Label Branding**: Supports dynamic, per-tenant white-label branding applied seamlessly at runtime via path-based workspace routing and CSS custom properties.
