  ...
  template: `
    <div class="block bg-white rounded-lg shadow-[0_1px_2px_rgba(15,23,42,0.04)] border border-slate-200 overflow-hidden">
      <div class="overflow-x-auto custom-scrollbar">
        <p-table [value]="documents()" styleClass="w-full text-left border-collapse">
                  ...
                  <div class="min-w-0">
                    ...
                    <div class="mt-1">
                      @if (!doc.departmentIds || doc.departmentIds.length === 0) {
                        <span class="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-slate-100 text-slate-600">Company wide</span>
                      } @else {
